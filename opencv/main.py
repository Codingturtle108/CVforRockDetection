...
# model.save(os.path.join('models', 'rockclassifier.h5'))

# # Load the new model

# new_model = load_model('./models/rockclassifier.h5')

# yhatnew = new_model.predict(np.expand_dims(resize/255, 0))
# one_hot_predictions = np.eye(yhatnew.shape[1])[np.argmax(yhatnew, axis=1)]
# print(one_hot_predictions)
